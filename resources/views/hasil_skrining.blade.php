        ...
        <div class="container">
            <div class="card">
                ...
                <div class="score-grid">
                    ...
                    {{-- Tambahan untuk Total Kesulitan --}}
                    @php
                ...
                <div class="section-box" style="background-color: #e8f4fc;">
                    <h4>📝 Rekomendasi & Keterangan per Kategori</h4>
                    ...
                    <p><strong>{{ ucwords(str_replace('_', ' ', $kategori)) }} ({{ ucfirst($status_lower) }})</strong></p>
                    @if ($status_lower === 'normal')
                    <ul>
                        <li><strong>Rekomendasi:</strong> Lanjutkan dengan memberikan informasi dan sosialisasi terkait kesehatan mental anak.</li>
                        <li><strong>Keterangan:</strong> Hasil ini menunjukkan bahwa anak tidak menunjukkan gejala yang signifikan dan berada dalam rentang normal.</li>
                    </ul>
                    @elseif ($status_lower === 'borderline' || $status_lower === 'ambang')
                    <ul>
                        <li><strong>Rekomendasi:</strong> Lakukan bimbingan atau konseling oleh guru BK atau profesional terkait.</li>
                        <li><strong>Keterangan:</strong> Hasil ini menunjukkan bahwa anak memiliki beberapa gejala yang perlu diperhatikan dan membutuhkan intervensi lebih lanjut.</li>
                    </ul>
                    @elseif ($status_lower === 'abnormal')
                    <ul>
                        <li><strong>Rekomendasi:</strong> Rujuk anak ke fasilitas kesehatan terdekat (seperti puskesmas atau rumah sakit) untuk pemeriksaan lebih lanjut.</li>
                        <li><strong>Keterangan:</strong> Hasil ini menunjukkan bahwa anak mengalami masalah emosi dan perilaku yang signifikan dan membutuhkan penanganan profesional.</li>
                    </ul>
                    @else
                    <p><em>Status tidak dikenali untuk kategori ini.</em></p>
                    @endif
                    <hr>
                    @endforeach
                </div>
