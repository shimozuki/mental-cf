...
<body class="screen-template-default single single-screen postid-22 not-front"> <noscript><iframe
			...
			<article id="post-22" class="post-22 screen type-screen status-publish hentry condition-depression">
				<div class="wrap normal">
					...
					<div class="page-heading plain">
						<h1 class="entry-title">Skrining</h1>
					</div>
				</div>
					...
					<div class="page-intro">
						<div class='gf_browser_safari gform_wrapper gform_legacy_markup_wrapper' id='gform_wrapper_1'
							...
							<div class='gform_heading'>
								<h3 class="gform_title">Skrining</h3> <span class='gform_description'></span>
							</div>
	...
	<script
		id='process_mhaActivity-js-extra'>
		var do_mhaActivity = {
	...
	<script
		id='process_mhaDiyTools-js-extra'>
		var do_mhaDiyTools = {
			"ajaxurl": "https:\/\/screening.mhanational.org\/wp-admin\/admin-ajax.php"
		};
	</script>
	...
	<script
		id='process_diyToolsExport-js-extra'>
	...
	<script
		id='process_mhaScreenEmail-js-extra'>
	...
	<script
		id='process_mhaContent-js-extra'>
		var do_mhaContent = {
			"ajaxurl": "https:\/\/screening.mhanational.org\/wp-admin\/admin-ajax.php"
		};
	</script>
